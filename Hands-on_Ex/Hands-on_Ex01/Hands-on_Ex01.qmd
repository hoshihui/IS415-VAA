...
```
*st_intersects() identify pre-schools inside each Planning Subzone and lengths() calculate number of pre-schools within the planning subzone*
*top_n list the subzone with most number of preschool. top_n(x: data frame, n: number of row to return, wt: variable to use for ordering)*
